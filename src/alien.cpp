...
Alien::Alien(Box2D const & box, Direction2D const & direction, float velocity, Ray2D const & route, std::weak_ptr<Space> spacePtr)
  : GameEntity(box, direction, velocity, spacePtr), m_route(route)
{}

Alien::Alien(Alien const & obj)
  : GameEntity(obj.m_box, obj.m_direction, obj.m_velocity, obj.m_spacePtr), m_route(obj.m_route)
{}
